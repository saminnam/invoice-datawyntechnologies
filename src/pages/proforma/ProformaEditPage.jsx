    ...
    try {
      ...
      if (invoiceRes.success) {
        ...
        setFormData({
          ...
          validUntil: invoice.validUntil ? invoice.validUntil.split('T')[0] : '',
      ...
      if (companyRes.success) setCompanySettings(companyRes.data)
    } catch (error) {
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Update invoice details below</p>
        </div>
        <button
          onClick={() => navigate(`/proforma/${id}`)}
